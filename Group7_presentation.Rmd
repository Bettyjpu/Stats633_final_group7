...
- While researchers find increases in global warming issue importance and perceived harm in different states, policy support increased more in certain states (California and New York) than elsewhere (Marlon and Wang).
...
- The demographic characteristics from the ACS are from the year 2023, and the climate opinion data is also from 2023.
...
## 4.2 Plot time series (select state)
  ...
  sidebarLayout(
    ...
    mainPanel(
      tags$div(
        style = "margin: 10px;",
        tags$p("
        1. There is limited increases (or even declines) in climate views
...
2. The influence of increased communication efforts is influencial on people's beliefs (happening) and risk perceptions (worried, harm personal) but less evident on public support for climate policies and on the selfreported discussion frequency with family and friends, which increased only 3 pp on average across all states during the past five years."),
        tags$p("Reference:"),
        tags$a(href = "https://pubmed.ncbi.nlm.nih.gov/34006886/", "https://pubmed.ncbi.nlm.nih.gov/34006886/")
      ),
...
## 4.3 Plot time series (select year)
